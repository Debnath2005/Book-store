        ...
        <div className="px-4 md:px-12 py-8 bg-zinc-900 flex flex-col lg:flex-row gap-8 items-start">
          <div className=" w-full lg:w-3/6  ">
             ...
             {isLoggedIn===true && role==="user" && (
               <div className="flex flex-col md:flex-row lg:flex-col items-center justify-center lg:justify-start mt-8 lg:mt-0 ">
             ...
             {isLoggedIn===true && role==="admin" && (
               ...
               <button className="text-red-500 rounded lg:rounded-full text-3xl p-3 mt-8 md:mt:0  bg-white flex items-center justify-center">
