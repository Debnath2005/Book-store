...
import { AiFillDelete, AiTwotoneAccountBook } from "react-icons/ai";
      ...
      {Cart && Cart.length===0 && (
        <div className='h-screen'>
          <div className='h-[100%] flex items-center justify-center flex-col'>
            ...
            <img src="" alt="empty Cart"  className='lg:[50vh]'/>
           ...
           {Cart.map((items,i)=>(
              ...
              key={i}>
                ...
                <div className='w-full md:w-auto'>
                    ...
                    <p className='text-normal text-zinc-300 mt-2 md:hidden'>
                      {items.desc.slice(0,100)}
                    </p>
                </div>
                <div className='flex mt-4 w-full md:w-auto items-center justify-between'>
                  ...
                  <button className='bg-red-100 text-red-700 border rounded p-2 ms-12 hover:bg-red-200'
